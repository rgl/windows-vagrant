...
$archiveUrl = 'https://github.com/PowerShell/PowerShell/releases/download/v7.2.2/PowerShell-7.2.2-win-x64.msi'
$archiveHash = '447b49fb3deaf1d1b632711a48978f18ae43f0a2fe4cdba007218026a6e39010'
