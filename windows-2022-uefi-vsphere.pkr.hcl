...
source "vsphere-iso" "windows-2022-uefi-amd64" {
  firmware      = "efi"
  CPUs          = 4
  RAM           = 4096
  ...
  iso_paths = [
    ...
    "[${var.vsphere_datastore}] iso/VMware-tools-windows-12.3.5-22544099.iso",
  ]
  network_adapters {
...
build {
  sources = ["source.vsphere-iso.windows-2022-uefi-amd64"]
