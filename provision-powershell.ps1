...
$archiveUrl = 'https://github.com/PowerShell/PowerShell/releases/download/v7.2.3/PowerShell-7.2.3-win-x64.msi'
$archiveHash = '64641608a24d21767a36ca5dd09d157b507847fdff620d61b80a14709518352b'
