...
$archiveUrl = 'https://github.com/PowerShell/PowerShell/releases/download/v7.2.4/PowerShell-7.2.4-win-x64.msi'
$archiveHash = '06b93c2263fbd6d975ac59e09ab2390635aff0455ad2504ffd60f0a5e0e61103'
